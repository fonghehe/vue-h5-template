...
`title` stores a translation key such as `app.home`. Layout and browser titles translate reactively. The bottom tabs appear only on the four main routes. The themed floating AI entry hides on Chat, Login, Cart, Payment and Details.
